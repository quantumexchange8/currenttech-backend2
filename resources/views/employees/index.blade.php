                                    ...
                                    <div class="card custom-dark-purple  p-3">
                                        <div class="row">
                                                ...
                                                <div class="d-flex flex-column align-items-center">
                                                    ...
                                                    <div class="row mt-3 align-items-center text-center">
                                                        <div class="col">
                                                            <div class="d-flex flex-column align-items-center">
                                                                <i class="fa fa-clock"
                                                                   style="color: rgba(207, 158, 172, 1)"></i>
                                                                <p class="mt-auto">96%</p>
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="d-flex flex-column align-items-center">
                                                                ...
                                                                <p class="mt-auto">lvl.1</p>
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="d-flex flex-column align-items-center">
                                                                <i class="fa fa-tasks"
                                                                   style="color: rgba(255, 170, 138, 1)"></i>
                                                                <p class="mt-auto">96%</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-7 ps-0">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col">
                                                        <a href="{{ route('employee_detail') }}" class="btn btn-primary mt-2 h-100 w-100">
